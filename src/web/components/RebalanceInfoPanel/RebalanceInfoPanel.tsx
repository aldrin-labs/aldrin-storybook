          ...
          <Grid container>
            <Grid container justify="space-between">
              ...
              <Grid item lg={4} justify="center">
                  ...
                  <StyledSubTypography fontWeight={'bold'} color={blue.light}>${firstColValue}</StyledSubTypography>
              </Grid>
              
              <Grid item lg={2} >
                  <StyledTypography fontWeight={'bold'} position="right">aviable value</StyledTypography>
                  <StyledSubTypography fontWeight={'bold'} color={green.custom} position="right">{secondColValue}</StyledSubTypography>
              </Grid>
              
              <Grid item lg={4} >
                  <StyledTypography fontWeight={'bold'} position="right">Available percentage</StyledTypography>
                  <StyledSubTypography fontWeight={'bold'} color={green.custom} position="right">{thirdColValue}</StyledSubTypography>
              </Grid>
          ...
          <Grid container>
            <Grid container justify="space-between">
              ...
              <Grid item lg={3}>
                  ...
                  <StyledSubTypography color={red.bright} fontWeight={'bold'} position="right">{fourthColValue}</StyledSubTypography> 
              </Grid>
