...
export default (
  <>
    ...
    <Typography gutterBottom={true}>
      ...
      Defense (&quot;DOD&quot;), our services are subject to the terms of these
      Terms of Use in accordance with FAR 12.212 (for computer software) and FAR
      12.211 (for technical data). If our services are acquired by or on behalf
      of any agency within the Department of Defense, our services are subject
      to the terms of these Terms of Use in accordance with Defense Federal
      Acquisition Regulation (&quot;DFARS&quot;) 227.7202&#8209;3. In addition,
      DFARS 252.227&#8209;7015 applies to technical data acquired by the DOD.
    ...
    <Typography gutterBottom={true}>
      ...
      Sussex County, Delaware. Except as otherwise provided herein, the Parties
