...
import Highlight from '@storybook/components/Highlight/Highlight'
...
export default class YearChart extends React.Component<IProfileChartProps, IProfileChartState> {
