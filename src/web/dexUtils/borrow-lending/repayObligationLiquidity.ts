...
export const repayObligationLiquidity = async ({
    ...
    const sourceLiquidityWallet = await checkAccountForMint({wallet, connection, mint: reserve.liquidity.mint, create: false});
    ...
    transaction.add(program.instruction.repayObligationLiquidity(amount, {
        accounts: {
            repayer: wallet.publicKey,
            obligation: obligation.pubkey,
            reserve: reserve.publicKey,
            sourceLiquidityWallet: sourceLiquidityWallet,
