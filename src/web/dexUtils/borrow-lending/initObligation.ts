import {
    Connection, Keypair, PublicKey, SystemProgram, SYSVAR_CLOCK_PUBKEY, Transaction,
} from '@solana/web3.js'
...
export const initObligation = async ({
    ...
    const initObligationInstruction = program.instruction.initObligationR10({
        accounts: {
            ...
            lendingMarket: new PublicKey('6zstoyUpKZ7iiuDND8th19BQHXrUmZ3auqxN2Ujq5vuz'),
    ...
    return await sendTransaction({
        transaction: new Transaction().add(createAccountInstruction).add(initObligationInstruction),
        wallet,
        signers: [newAccount],
        connection,
        focusPopup: true,
