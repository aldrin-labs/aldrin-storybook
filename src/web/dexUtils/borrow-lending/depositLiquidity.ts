...
export const depositLiquidity = async ({
    ...
    const collateralWallet = await checkAccountForMint({wallet, connection, mint: reserve.collateral.mint, create: true});
    const sourceLiquidityWallet = await checkAccountForMint({wallet, connection, mint: reserve.liquidity.mint, create: true});

    console.log('depositLiqCollateralWallet', collateralWallet.toString(), sourceLiquidityWallet.toString())
