...
export const PLUTONIANS_STAKING_POOL_ADDRESS = MASTER_BUILD
  ? 'BwhPMphP66m4tfJGTpxB4buCkyoUBFnrWWc7ZbvHS77E' // TODO: CHANGE IT WHEN PROD POOL WOULD BE CREATED
  : 'BwhPMphP66m4tfJGTpxB4buCkyoUBFnrWWc7ZbvHS77E' // TODO: CHANGE IT WHEN DEV POOL WOULD BE CREATED

// Plutonians staking reward
export const PU238_TOKEN_MINT = MASTER_BUILD
  ? '7p6zGHdmWHvCH4Lsik2MoMBXqPGhFbSPSceSBXd8KNEC'
  : '3UGQ4Xpx8RBBjRGkTktm7j9raPn5tv91bScVKjNMyBiD'
