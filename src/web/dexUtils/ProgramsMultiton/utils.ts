...
export const PLUTONIANS_RPC_STAKING_POOL_ADDRESS =
  '8x1JWvRnjNguHwfNLRqQTWNHGSnMixcaAKVQxFWdXbpL'

export const PLUTONIANS_PU_STAKING_POOL_ADDRESS =
  'CAXmf7MF78xyQTCsLdV8RJHNpqth8nVmj8DhXtFtTR7a'
