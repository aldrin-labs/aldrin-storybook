...
import {
  ...
  filterDataBySymbolForDifferentDividers,
  filterSelectorDataByTab,
...
const SelectPairListComponent = (props: IPropsSelectPairListComponent) => {
  ...
  const [isAddMarketPopupOpen, setIsAddMarketPopupOpen] = useState(false)
  ...
  return (
    ...
    >
      ...
      <TableFooter container>
        ...
        {/* <Row
          ...
          onClick={async (e) => {
            ...
            this.setState({ isAddMarketPopupOpen: true })
            closeMenu()
          }}
        >
          + Add Market
      ...
      <CustomMarketDialog
        theme={theme}
        open={isAddMarketPopupOpen}
        onClose={() => setIsAddMarketPopupOpen(false)}
