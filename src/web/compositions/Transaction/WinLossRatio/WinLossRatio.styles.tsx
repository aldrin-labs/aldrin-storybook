...
import { TransactionActionsNumber } from './../TransactionsActionsStatistic/TransactionsActionsStatistic.styles'
...
export const WinLossRatioChart = styled.div`
  ...
  background: linear-gradient(
    #2f7619 ${(props) => props.win || 50}%,
    #b93b2b ${(props) => props.win || 50}%
  );
`
...
export const WinLossSelect = styled(ReactSelectCustom)`
  ...
  .custom-select-box__dropdown-indicator {
    left: 0;
  }
