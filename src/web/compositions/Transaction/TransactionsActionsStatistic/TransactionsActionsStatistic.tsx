...
class TransactionsActionsStatistic extends Component {
  render() {
    ...
    const dayActionsSummary = getActionsSummary(
      dayActions.myPortfolios[0].portfolioActions.trades
    )
    const weekActionsSummary = getActionsSummary(
      weekActions.myPortfolios[0].portfolioActions.trades
    )
