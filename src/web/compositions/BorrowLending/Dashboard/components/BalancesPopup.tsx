            ...
            <RowContainer>
                ...
                <Cell col={12} colLg={3}>
                    <TextBlock>
                        ...
                        <DescriptionBlock>{depositApy % 1 !== 0 ? depositApy.toFixed(2) : depositApy}%</DescriptionBlock>
                    </TextBlock>
                </Cell>
                <Cell col={12} colLg={6}>
                    <TextBlock>
            ...
            <RowContainer justify="flex-start">
                ...
                <Cell col={12} colLg={3}>
                    <TextBlock>
                        ...
                        <DescriptionBlock>{borrowApy % 1 !== 0 ? borrowApy.toFixed(2) : borrowApy}%</DescriptionBlock>
                    </TextBlock>
                </Cell>
                <Cell col={12} colLg={6}>
                    <TextBlock>
