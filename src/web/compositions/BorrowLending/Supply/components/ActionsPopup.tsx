...
const ActionsPopup = ({
    ...
    maxLtv: number,
    handleDepositLiq: (reserve: any, amount: number, asColateral: boolean) => void,
    ...
    const ballanceAfterDeposit = +walletBalance - amount;
    const depositAfterDeposit = +depositAmount + amount;

    const ballanceAfterWithdraw = +walletBalance + amount;
    const depositAfterWithdraw = +depositAmount - amount;
                    ...
                    <SupplyCard>
                        <BlockSupply>
                            ...
                            <div style={{textAlign: 'left', marginTop: '0.3rem'}}>
                                {mode ?
                                    <MaxAmount>Max Amount: {depositAmount} </MaxAmount>
                                    :
                            ...
                            {mode ?
                                <ButtonGroup>
                                    <BlueButton
                                        ...
                                        onClick={() => handleWithdrawLiquidity(reserve, amount)}
                                    >
                                        Withdraw Liquidity
                                    </BlueButton>
                                    <BlueButton
                                        ...
                                        onClick={() => handleWithdrawCollateral(reserve, amount)}
                                    >
                                        Withdraw Collateral
                                    </BlueButton>
                                </ButtonGroup>
                                ...
                                <>
                                    <BlueButton
                                        ...
                                        style={{alignSelf: 'center', marginTop: '2rem'}}
                                        disabled={amount === 0}
                                        onClick={() => handleDepositLiq(reserve, amount, asCollateral)}
                                    >
                                        Confirm
                                    </BlueButton>
                                </>
