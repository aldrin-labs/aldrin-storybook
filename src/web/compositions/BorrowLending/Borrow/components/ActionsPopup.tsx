...
const ActionsPopup = ({
    ...
    const ballanceAfterRepay = removeTrailingZeros((+walletBalance - amount).toFixed(tokenDecimals));
                        ...
                        <RowContainer>
                            ...
                            <Cell col={12} colLg={3}>
                                <BlockSupply>
                                    ...
                                    {parseInt(u192ToBN(reserve.config.fees.borrowFee).toString())/Math.pow(10, 18)}%
                                </BlockSupply>
                            </Cell>
                            <Cell col={12} colLg={3}>
                                <BlockSupply>
                        ...
                        <RowContainer>
                            ...
                            <Cell col={6}>
                                <BlockSupply>
                                    <TitleBlock>Wallet Balance</TitleBlock>
                                    {mode ?
                                        ballanceAfterRepay < 0 ? 0 : ballanceAfterRepay
                                        :
                                        ballanceAfterBorrow < 0 ? 0 : ballanceAfterBorrow
                                    }
                                    <a
                                        href={`https://explorer.solana.com/address/${reserve.liquidity.mint.toString()}`}
                                        target="_blank"
