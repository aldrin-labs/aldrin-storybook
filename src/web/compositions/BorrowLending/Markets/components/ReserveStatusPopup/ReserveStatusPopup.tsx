      ...
      <RowContainer>
        <Cell col={12} colLg={6}>
          <TextBlock>
            ...
            <DescriptionBlock>
              ${toNumberWithDecimals(availableLiqWorth, 2)}
            </DescriptionBlock>
          </TextBlock>
          <TextBlock>
            ...
            <DescriptionBlock>
              ${toNumberWithDecimals(borrowedAmountWorth, 2)}
            </DescriptionBlock>
          </TextBlock>
        </Cell>
        <Cell col={12} colLg={6}>
          <UtilizationChart>
            ...
            <SubtitleBlock>{utilization.toFixed(2)}%</SubtitleBlock>
          </UtilizationChart>
        </Cell>
      </RowContainer>
      ...
      <RowContainer>
        <StatsList>
          ...
          <StatsItem>
            ...
            <StatsDescription>{depositApy.toFixed(2)}%</StatsDescription>
          </StatsItem>
        </StatsList>
      </RowContainer>
